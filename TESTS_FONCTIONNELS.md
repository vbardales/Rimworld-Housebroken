...
Manual acceptance tests for RimWorld 1.6. Originally written on September 12, 2026 from the code and documentation; translated and extended on September 13. **TF-01 to TF-14 were played by Pickle in a headless game on September 25 (see the execution record). TF-15 to TF-22 have not run.** Existing scenario IDs and execution history are preserved.
...
| TF-15 to TF-22 | — | — | Scenarios written for Pickle, not yet run. See `TESTING.md`. | Not executed | — |
