...
Manual acceptance tests for RimWorld 1.6. Originally written on September 12, 2026 from the code and documentation; translated and extended on September 13. **TF-01 to TF-14 were played by Pickle in a headless game on September 25 (see the execution record). TF-15, TF-17, TF-18 (first half) and TF-19 (second game) followed; the rest of TF-15 to TF-22 has not run.** Existing scenario IDs and execution history are preserved.
...
| TF-16, TF-20, TF-21, TF-22, and the rest of TF-15 and TF-18 | — | — | Scenarios written for Pickle, not yet run. See `TESTING.md`. | Not executed | — |
